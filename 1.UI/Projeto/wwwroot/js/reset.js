...
$('form').on('submit', function(event){
    ...
    // Esse código pega o valor de um parâmetro chamado "id" na URL do navegador
    // Esse id posteriormente será necessario para resetar a senha do usuário
    ...
    var formData = {
        Senha: $("#senha-146").val(),            // Pega a senha
    ...
    $.ajax({
        ...
        url: "http://localhost:5068/api/User/reset", // URL para onde os dados serão enviados
